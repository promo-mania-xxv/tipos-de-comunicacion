document.addEventListener('DOMContentLoaded', () => {
    ...
    function setupEventListeners() {
        ...
        presentation.addEventListener('touchmove', handleTouchMove, { passive: false });
        presentation.addEventListener('touchend', handleTouchEnd);
    ...
    function handleTouchMove(e) {
        ...
        // Only prevent default and track swipe if horizontal swipe
